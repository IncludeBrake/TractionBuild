    ...
    def run(self, avatars: Dict[str, Any], lead_magnets: Dict[str, Any]) -> Dict[str, Any]:
        ...
        email_sequence = {
            "welcome_email": {
                ...
                "body": "Thanks for joining the ZeroToShip community..."
            },
            "day_1": {
            ...
            "day_7": {
                "subject": "How ZeroToShip Built This in 72hrs",
...
class EmailSequenceBottomFunnelNode(BaseNode):
    ...
    def run(self, urgency_mapping: Dict[str, Any]) -> Dict[str, Any]:
        ...
        bottom_funnel_emails = {
            "trial_activation": {
                "subject": "Your ZeroToShip project is ready! 🚀",
...
class GenerateXTweetsForAvatarNode(BaseNode):
    ...
    def run(self, avatar_name: str, hooks: Dict[str, Any]) -> Dict[str, Any]:
        ...
        tweets = [
            f"🚀 Weekend Hack:\nTurn your napkin idea into a *real*, deployed, **selling** product.\n\nNo code. No team. Just your brain + ZeroToShip.\n\n✅ Market research\n✅ MVP build\n✅ Launch-ready marketing\n\nTry it → https://zerotoship.ai",
            f"💡 {hook['primary_hook']}\n\n{hook['secondary_hook']}\n\n{hook['cta']} → https://zerotoship.ai",
            f"🔥 Hot take: You're not building. You're configuring.\n\nLet ZeroToShip handle the boilerplate.\n\nYou focus on your vision.\n\nResults: 48-hour time-to-value.\n\nLearn more → https://zerotoship.ai"
        ]
...
class CreateYouTubeScriptIntroNode(BaseNode):
    ...
    def run(self, hooks: Dict[str, Any]) -> Dict[str, Any]:
        ...
        script = {
            ...
            "intro": "Meet ZeroToShip. It's like hiring a dev team, PM, and CMO—without spending 10 grand.",
            "demo_sections": [
                "Show app interface",
                "Show Stripe ping notification",
                "Show analytics dashboard"
            ],
            "call_to_action": "Try ZeroToShip free at zerotoship.ai"
        }
        ...
        drip_sequence = {
            "inactive_users": {
                ...
                "day_3": {
                    ...
                    "body": "Your ZeroToShip project is 80% complete..."
                },
                "day_7": {
...
class SalespageForCaseStudyNode(BaseNode):
    ...
    def run(self, case_study_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        sales_page = {
            ...
            "solution": "Used ZeroToShip to validate, build, and launch in one weekend",
            "results": [
            ...
            "testimonial": "ZeroToShip turned my weekend project into a real business. I couldn't have done it without them.",
