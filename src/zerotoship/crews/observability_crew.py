"""
Observability Crew for ZeroToShip.
...
class ObservabilityCrew(BaseCrew):
    """Crew responsible for monitoring, analyzing, and improving ZeroToShip performance."""
    ...
    def _create_crew(self) -> Crew:
        ...
        metrics_collector = Agent(
            ...
            goal="Collect and aggregate real-time metrics from all ZeroToShip components",
        ...
        tasks = [
            Task(
                description="Collect current metrics from all ZeroToShip components including workflow execution times, error rates, API usage, and carbon footprint",
            ...
            Task(
                description="Based on all collected data, generate specific, actionable recommendations for improving ZeroToShip performance, quality, and efficiency",
