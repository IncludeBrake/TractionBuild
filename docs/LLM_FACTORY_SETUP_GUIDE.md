...
The LLM Factory provides a centralized, flexible way to manage LLM providers in tractionbuild. It supports OpenAI, Anthropic, and Ollama with secure API key management through HashiCorp Vault.
...
```bash
# tractionbuild Environment Configuration
...
CODECARBON_PROJECT_NAME=tractionbuild
...
vault kv put secret/tractionbuild/llm/openai api_key="your_openai_api_key_here"
vault kv put secret/tractionbuild/llm/anthropic api_key="your_anthropic_api_key_here"

# Store Twitter API credentials

vault kv put secret/tractionbuild/twitter bearer_token="your_twitter_bearer_token"
vault kv put secret/tractionbuild/twitter api_key="your_twitter_api_key"
vault kv put secret/tractionbuild/twitter api_secret="your_twitter_api_secret"
vault kv put secret/tractionbuild/twitter access_token="your_twitter_access_token"
vault kv put secret/tractionbuild/twitter access_token_secret="your_twitter_access_token_secret"
...
from src.tractionbuild.utils.llm_factory import get_llm
llm = get_llm()
...
python -c "
import asyncio
from src.tractionbuild.crews.advisory_board_crew import AdvisoryBoardCrew
...
- `src/tractionbuild/crews/base_crew.py` - Base class with LLM Factory integration

- `src/tractionbuild/crews/advisory_board_crew.py` - Advisory Board Crew

- `src/tractionbuild/crews/builder_crew.py` - Builder Crew

- `src/tractionbuild/crews/execution_crew.py` - Execution Crew

- `src/tractionbuild/crews/marketing_crew.py` - Marketing Crew

- `src/tractionbuild/crews/validator_crew.py` - Validator Crew
...
vault write auth/approle/role/tractionbuild policies=tractionbuild-policy
...
from src.tractionbuild.utils.llm_factory import test_llm_connection
