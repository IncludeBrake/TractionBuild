...
## What’s included
- `src/tractionbuild/core/agent_registry.py` — registry that returns adapter-wrapped crews
- `src/tractionbuild/core/workflow_engine.py` — fixed imports + lean engine
- `src/tractionbuild/crews/adapters.py` — proper imports + schema enforcement
- `src/tractionbuild/api/app_v1.py` — minimal FastAPI app with 3 routes
...
## Apply the patch
Unzip the contents of `tractionbuild_glue_patch.zip` into your repo root so files land under `src/tractionbuild/...`.
