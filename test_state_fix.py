#!/usr/bin/env python3
"""
Test script to validate the state KeyError fix for ZeroToShip.
...
from zerotoship.core.schema_validator import validate_and_enrich_data
...
async def main():
    """Run all tests."""
    print("🚀 ZeroToShip State Management Fix Validation")
    print("=" * 50)
