#!/usr/bin/env python3
"""
E2E Test for tractionbuild API
...
async def main():
    ...
    print("🚀 Starting tractionbuild E2E Test")
    ...
    try:
        ...
        print(f"   Total requests: {metrics.get('tractionbuild_requests_total', 0)}")
        print(f"   Projects created: {metrics.get('tractionbuild_projects_created', 0)}")
        print(f"   Projects retrieved: {metrics.get('tractionbuild_projects_retrieved', 0)}")
